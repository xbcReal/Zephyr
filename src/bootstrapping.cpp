...
}//这个函数生成一个指定大小的向量，其中的每个元素都是一个在 -1 到 1 之间均匀分布的随机实数
...
int main() {
  ...
  //这个模数链有1+remaining_level+boot_level+1(51,46,51,51)
  ...
  keygen.create_relin_keys(relin_keys);//重线性化密钥
  GaloisKeys gal_keys;
  ...
  cout << "Size of input: " << slot_count << endl;

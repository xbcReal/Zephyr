...
def generate_matrices():
    np.random.seed(42)
    matrix_128x768 = np.random.uniform(-1, 1, (128, 768))
    matrix_768x768 = np.random.uniform(-1, 1, (768, 768))

    return matrix_768x768, matrix_128x768
...
matrix_768x768, matrix_128x768 = generate_matrices()
result_matrix = multiply_matrices(matrix_128x768, matrix_768x768)


save_matrix_to_txt(matrix_768x768, "input/matrixmul_input_m_128_n_768_k_768.txt")
save_matrix_to_txt(matrix_128x768, "input/matrix_input_n_768_m_128.txt")
save_matrix_to_txt(result_matrix, "calibration/matrix_output_m_128_k_768.txt")
